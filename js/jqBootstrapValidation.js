    ...
    var defaults = {
                ...
                return this.each(function() {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Ceci n'est pas une adresse Email ! <!-- data-validator-validemail-message to override -->";
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "Vous n'avez pas tout rempli !<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
